        ...
        {userData ? (
          <div className="space-y-4">
            ...
            {payment?.includes("GENERAL") && payment?.includes("WORKSHOP") ? (
              ...
              <div className="font-semibold text-3xl">Kit : General</div>
            ) : payment?.includes("WORKSHOP") ? (
              <div className="font-semibold text-3xl">Kit : Workshop</div>
            ) : (
              <div className="font-semibold text-3xl">Kit : None</div>
            )}
            {userData.kit && (
              <div className="text-red-600 font-semibold text-3xl">
